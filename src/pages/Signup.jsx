                        ...
                        <form action="">
                            ...
                            <div className="lg:w-[60%] w-full flex flex-wrap justify-between">
                                <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5 relative">
                                    <h3 className='font-sans text-[16px] leading-[23px] font-bold text-[#262626]'>Password</h3>
                                    ...
                                    <div onClick={() => setPshow(!pshow)} className="absolute right-0 top-[50%] translate-y-[-50%]">
                                        {pshow == true ? <IoMdEyeOff /> : <IoMdEye />}
